package com.astromedicomp.tworotatingshapeswithcolor3d;

import com.astromedicomp.tworotatingshapeswithcolor3d.GLESMacros;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
	...
	private int[] vbo_quads_color = new int[1];
...
// ************************************************ Quads Block ***********************************************        
        ...
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,vbo_triangle_color[0]);
         ...
         byteColorBuffer=ByteBuffer.allocateDirect(quadColor.length * 4);
        byteColorBuffer.order(ByteOrder.nativeOrder());
         verticesColorBuffer=byteColorBuffer.asFloatBuffer();
        verticesColorBuffer.put(quadColor);
        verticesColorBuffer.position(0);
