package com.astromedicomp.triangle;

import com.astromedicomp.triangle.GLESMacros;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
	...
	private float orthoGraphicProjectionMatrix[] = new float[16]; // 4x4 matrix of orthogrpahic projection make it 0
