package com.astromedicomp.tworotatingshapeswithcolor;

import com.astromedicomp.tworotatingshapeswithcolor.GLESMacros;
...
//**************************** Triangle draw ***********************************************************        
        ...
        Matrix.translateM(modelViewMatrix,0,-(float)1.5f, (float)0.0f, (float)-5.0f);
...
//**************************** Triangle draw ***********************************************************
		...
		Matrix.rotateM(rotationMatrix, 0, angleRotate, 1.0f, 0.0f, 0.0f);
