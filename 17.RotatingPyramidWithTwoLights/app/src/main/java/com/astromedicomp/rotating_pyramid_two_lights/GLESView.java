package com.astromedicomp.rotating_pyramid_two_lights;

import com.astromedicomp.rotating_pyramid_two_lights.GLESMacros;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private int  ldUniform, kdUniform, lightPositionUniform,lightPositionUniformRight,ldUniformRight;
    ...
    private void initialize(GL10 gl)
    {
		...
		ldUniformRight = GLES32.glGetUniformLocation(shaderProgramObject, "u_Ld_r");
        kdUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_Kd");
        lightPositionUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_light_position");;
		lightPositionUniformRight = GLES32.glGetUniformLocation(shaderProgramObject, "u_light_position_right");;
...
// ************************************************ Quads Block ***********************************************
	...
	private void draw() {
		...
		if(doubleTap==1)
        {
            ...
            GLES32.glUniform3f(ldUniform, 1.0f, 0.0f, 0.0f); // diffuse intensity of light
			...
			GLES32.glUniform3f(ldUniformRight, 0.0f, 0.0f, 1.0f); // diffuse intensity of light
            GLES32.glUniform3f(kdUniform, 0.5f, 0.5f, 0.5f); // diffuse reflectivity of material
            float[] lightPositionRight = {-2.0f, 0.0f, 2.0f, 1.0f};
            GLES32.glUniform4fv(lightPositionUniformRight, 1, lightPositionRight,0); // light position
        }
        else
        {
