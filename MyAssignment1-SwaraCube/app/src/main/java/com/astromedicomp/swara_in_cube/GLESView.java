package com.astromedicomp.swara_in_cube;

import com.astromedicomp.swara_in_cube.GLESMacros;
...
//**************************** Quads draw ***********************************************************
		Matrix.setIdentityM(modelViewMatrix,0);
        Matrix.translateM(modelViewMatrix,0,(float)0.0f, (float)0.0f, (float)-7.0f);
